    ...
    myConnector.getData = function(table, doneCallback) {
        ...
        deferredObj.promise().then(function() { 
            while(offset < 500){
                ...
                var xhr = $.ajax({
                            type: 'GET',
                            url: gbizinfo_api_url + '+' + offset + '+LIMIT+100',
                            dataType: 'json',
                            async: false
                    ...
                    resp.results.bindings.forEach(function(data){
                        tableData.push({
                            ...
                            "certificationDate": data.certificationDate.value,
                            "activityName": data.activityName.value,
                            "subsidy": data.subsidy.value,
                            "certifiedObject": data.certifiedObject.value,
                            "puborgName": data.puborgName.value,
                            "remmei": data.remmei.value,
                        });    
                    })
                    offset=offset+100;
                }).fail(function() {
